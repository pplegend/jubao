...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home', ['results'=>$records,'action'=>'search/jubaophones','placeholder'=>'搜索号码/部门','type'=>-1,'active'=>'jubaophones']);
    }
    ...
    public function search(Request $request,$search){
        ...
        if($search == 'jubaophones'){
            ...
            $searchRecords = $this->getRecordFromDb('pz_table','title' , request('context'),request('type'));
            $action = '/search/shoujis';
            $view = 'searchresult';
        }

        return view($view, ['results'=>$searchRecords,'action'=>$action,'placeholder'=>$placeholder,'type'=>request('type')]);
    }
    ...
    public function getRecordFromDb($table,$field,$value,$type){
        $records = DB::table($table)
